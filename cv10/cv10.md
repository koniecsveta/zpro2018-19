...
Vícenásobné ukazatele se používajú nejčastějšie pri viacerozmerných datových štruktúrach,
 ako sú matice alebo všeobecne polia polí.
   ...
   Program bude využívať adresovú aritmetiku. PreŠtudujte si triediaci algoritmus quisk sort (https://en.wikipedia.org/wiki/Quicksort#Algorithm) . Doplnte kód funkcie compare().
